...
class TestParseProbeOutput(unittest.TestCase):
    ...
    def test_ffprobe_video10(self):
        file = os.path.join(TEST_FILE_PATH, 'COLB001 Color Bar.mov.ffprobe')
        self.assertEqual(MediaProbe.get_params_from_ffprobe(open(file, 'r')),
                         {'bit_rate': '27980000',
                          'duration': '33.1',
                          'filename': 'PANORAMA 20 VOD.mxf',
...
class TestGetMediaInputParams(unittest.TestCase):

    def test_color_bar(self):
        self.assertEqual(MediaProbe.get_media_file_input_params(os.path.join(TEST_FILE_PATH, 'COLB001 Color Bar.mp4')),
                         {'bit_rate': '96000',
                          'start_time': '0.021333', 'duration': '13.5',
                          'format_long_name': 'QuickTime / MOV',
                          'filename': '/home/flaviopontes/PycharmProjects/ffmpymedia/test_files/COLB001 Color Bar.mp4',
                          'format_name': 'mov,mp4,m4a,3gp,3g2,mj2',
                          'tags': {'minor_version': '512', 'encoder': 'Lavf55.19.104',
                          ...
                          'streams': [
                              {'index': '0',
                               'codec_long_name': 'H.264 / AVC / MPEG-4 AVC / MPEG-4 part 10',
                               'reported_frame_rate': '29.97',
                               'codec_time_base': '59.94', 'codec': 'h264', 'codec_tag': '0x31637661',
                               'width': '1920',
                               ...
                               'height': '1080',
                               'bitrate': '23',
                               'disposition': {'clean_effects': 0, 'attached_pic': 0, 'forced': 0, 'dub': 0,
                                               'visual_impaired': 0, 'hearing_impaired': 0, 'karaoke': 0, 'original': 0,
                                               'comment': 0, 'default': 1, 'lyrics': 0},
                               },
                              {'codec_long_name': 'AAC (Advanced Audio Coding)',
                               'sample_rate': '48000',
                               'codec': 'aac',
